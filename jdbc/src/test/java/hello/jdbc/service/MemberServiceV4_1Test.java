 ...
 * -> 덕분에 향후 JDBC 외의 다른 구현기술을 사용하게 되더라도 서비스 계층은 그 영향을 받지 않게 된다.
 * -
 * (남은 문제)
 * Repository 계층에서 넘어오는 특정 예외의 경우 처리를 시도할 수도 있다 (복구시도).
 * 특정 상황에서 특정 예외에 대하여 복구를 시도하고 싶은 경우 어떻게 코드를 구성할 수 있을 까?
 */
@Slf4j
@SpringBootTest
